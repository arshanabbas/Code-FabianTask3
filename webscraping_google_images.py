...
chromePath = r'D:/Webscraping/chromedriver.exe'
driver = webdriver.Chrome(chromePath)

search_URL = "https://www.google.com/search?q=real%20farmland%20blueberry%20agriculture%20level%20images&tbm=isch&hl=en&chips=q:real%20farmland%20blueberry%20agriculture%20level%20images%2Conline_chips:blueberry%20crop:nXhUbqPRDg4%3D%2Conline_chips:hydroponic%20blueberries:l3F2nmgYPI4%3D&tbs=isz:l&sa=X&ved=0CAIQpwVqFwoTCMiywNjbpP8CFQAAAAAdAAAAABAD&biw=1263&bih=577"
...
for i in range(1, len_containers + 1):
    ...
    while True:
        ...
        imageElement = driver.find_element_by_xpath(
            """//*[@id="Sva75c"]/div[2]/div/div[2]/div[2]/div[2]/c-wiz/div/div/div/div[3]/div[1]/a/img""")
